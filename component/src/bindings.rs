...
pub mod component {
    pub mod spin_test_runner {
        ...
        pub mod spin {
            ...
            pub type HttpRequest = super::super::super::wasi::http::types::IncomingRequest;
            pub type HttpResponse = super::super::super::wasi::http::types::IncomingResponse;
            ...
            unsafe impl _rt::WasmResource for Instance {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "component:spin-test-runner/spin")]
                        extern "C" {
            ...
            impl Instance {
                ...
                pub fn create() -> Result<Instance, _rt::String> {
                    unsafe {
                        #[repr(align(4))]
                        ...
                        #[link(wasm_import_module = "component:spin-test-runner/spin")]
                        extern "C" {
                            #[link_name = "[static]instance.create"]
                        ...
                        match l1 {
                            0 => {
                                let e = {
                                    ...
                                    Instance::from_handle(l2 as u32)
                                };
                                Ok(e)
                            }
                            1 => {
            ...
            impl Instance {
                ...
                pub fn trigger_http(&self, req: HttpRequest) -> HttpResponse {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        #[link(wasm_import_module = "component:spin-test-runner/spin")]
                        extern "C" {
                            #[link_name = "[method]instance.trigger-http"]
                        ...
                        let ret = wit_import((self).handle() as i32, (&req).take_handle() as i32);
                        super::super::super::wasi::http::types::IncomingResponse::from_handle(
                            ret as u32,
                        )
                    }
                }
    ...
    pub mod component {
        pub mod spin_test_runner {
            ...
            pub mod host_impls {
                ...
                #[repr(transparent)]
                pub struct KeyValue {
                    handle: _rt::Resource<KeyValue>,
                }

                type _KeyValueRep<T> = Option<T>;
                ...
                impl KeyValue {
                    ...
                    /// create a handle. The owned handle is then returned as `KeyValue`.
                    pub fn new<T: GuestKeyValue>(val: T) -> Self {
                        Self::type_guard::<T>();
                        let val: _KeyValueRep<T> = Some(val);
                        let ptr: *mut _KeyValueRep<T> = _rt::Box::into_raw(_rt::Box::new(val));
                        unsafe { Self::from_handle(T::_resource_new(ptr.cast())) }
                    }

                    /// Gets access to the underlying `T` which represents this resource.
                    pub fn get<T: GuestKeyValue>(&self) -> &T {
                    ...
                    /// resource.
                    pub fn get_mut<T: GuestKeyValue>(&mut self) -> &mut T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.as_mut().unwrap()
                    }

                    /// Consumes this resource and returns the underlying `T`.
                    pub fn into_inner<T: GuestKeyValue>(self) -> T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.take().unwrap()
                    }
                    ...
                    // It's theoretically possible to implement the `GuestKeyValue` trait twice
                    ...
                    fn as_ptr<T: GuestKeyValue>(&self) -> *mut _KeyValueRep<T> {
                        KeyValue::type_guard::<T>();
                        unsafe { T::_resource_rep(self.handle()).cast() }
                    }
                }

                /// A borrowed version of [`KeyValue`] which represents a borrowed value
                /// with the lifetime `'a`.
                #[derive(Debug)]
                #[repr(transparent)]
                pub struct KeyValueBorrow<'a> {
                    rep: *mut u8,
                    _marker: core::marker::PhantomData<&'a KeyValue>,
                }

                impl<'a> KeyValueBorrow<'a> {
                    #[doc(hidden)]
                    ...
                    fn as_ptr<T: 'static>(&self) -> *mut _KeyValueRep<T> {
                        KeyValue::type_guard::<T>();
                        self.rep.cast()
                    }
                }

                unsafe impl _rt::WasmResource for KeyValue {
                    #[inline]
                    unsafe fn drop(_handle: u32) {
                        #[cfg(not(target_arch = "wasm32"))]
                        unreachable!();
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:spin-test-runner/host-impls"
                            )]
                            extern "C" {
                                #[link_name = "[resource-drop]key-value"]
                                fn drop(_: u32);
                            }
                ...
                pub unsafe fn _export_constructor_key_value_cabi<T: GuestKeyValue>() -> i32 {
                    let result0 = KeyValue::new(T::new());
                    (result0).take_handle() as i32
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_key_value_set_cabi<T: GuestKeyValue>(
                    arg0: i32,
                    arg1: *mut u8,
                    arg2: usize,
                    arg3: *mut u8,
                    ...
                    let len1 = arg4;
                    T::set(
                        KeyValueBorrow::lift(arg0 as u32 as usize).get(),
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_key_value_state_cabi<T: GuestKeyValue>(
                    arg0: i32,
                ) -> *mut u8 {
                    let result0 = T::state(KeyValueBorrow::lift(arg0 as u32 as usize).get());
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_method_key_value_state<T: GuestKeyValue>(
                    arg0: *mut u8,
                ) {
                ...
                pub trait Guest {
                    type KeyValue: GuestKeyValue;
                }
                pub trait GuestKeyValue: 'static {
                    #[doc(hidden)]
                        ...
                        Self: Sized,
                    {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            ...
                            extern "C" {
                                #[link_name = "[resource-new]key-value"]
                                fn new(_: *mut u8) -> u32;
                            }
                            new(val)
                        }
                        ...
                        Self: Sized,
                    {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            ...
                            extern "C" {
                                #[link_name = "[resource-rep]key-value"]
                                fn rep(_: u32) -> *mut u8;
                            }
                            unsafe { rep(handle) }
                        }
                    ...
                    fn state(&self) -> _rt::Vec<(_rt::String, _rt::Vec<u8>)>;
                }
                #[doc(hidden)]

                macro_rules! __export_component_spin_test_runner_host_impls_cabi{
    ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

      #[export_name = "component:spin-test-runner/host-impls#[constructor]key-value"]
      unsafe extern "C" fn export_constructor_key_value() -> i32 {
        $($path_to_types)*::_export_constructor_key_value_cabi::<<$ty as $($path_to_types)*::Guest>::KeyValue>()
      }
      #[export_name = "component:spin-test-runner/host-impls#[method]key-value.set"]
      unsafe extern "C" fn export_method_key_value_set(arg0: i32,arg1: *mut u8,arg2: usize,arg3: *mut u8,arg4: usize,) {
        $($path_to_types)*::_export_method_key_value_set_cabi::<<$ty as $($path_to_types)*::Guest>::KeyValue>(arg0, arg1, arg2, arg3, arg4)
      }
      #[export_name = "component:spin-test-runner/host-impls#[method]key-value.state"]
      unsafe extern "C" fn export_method_key_value_state(arg0: i32,) -> *mut u8 {
        $($path_to_types)*::_export_method_key_value_state_cabi::<<$ty as $($path_to_types)*::Guest>::KeyValue>(arg0)
      }
      #[export_name = "cabi_post_component:spin-test-runner/host-impls#[method]key-value.state"]
      unsafe extern "C" fn _post_return_method_key_value_state(arg0: *mut u8,) {
        $($path_to_types)*::__post_return_method_key_value_state::<<$ty as $($path_to_types)*::Guest>::KeyValue>(arg0)
      }
    };);
  }
                #[doc(hidden)]
                pub(crate) use __export_component_spin_test_runner_host_impls_cabi;
                #[repr(align(4))]
            ...
            pub mod runner {
                ...
                pub type HttpResponse =
                    super::super::super::super::wasi::http::types::IncomingResponse;
                pub type KeyValue = super::super::super::super::exports::component::spin_test_runner::host_impls::KeyValue;
                pub type KeyValueBorrow<'a> = super::super::super::super::exports::component::spin_test_runner::host_impls::KeyValueBorrow<'a>;

                #[derive(Debug)]
                #[repr(transparent)]
                pub struct RuntimeBuilder {
                    handle: _rt::Resource<RuntimeBuilder>,
                }

                type _RuntimeBuilderRep<T> = Option<T>;
                ...
                impl RuntimeBuilder {
                    ...
                    /// This function will create a new resource handle by moving `val` onto
                    /// the heap and then passing that heap pointer to the component model to
                    /// create a handle. The owned handle is then returned as `RuntimeBuilder`.
                    pub fn new<T: GuestRuntimeBuilder>(val: T) -> Self {
                        Self::type_guard::<T>();
                        let val: _RuntimeBuilderRep<T> = Some(val);
                        let ptr: *mut _RuntimeBuilderRep<T> =
                            _rt::Box::into_raw(_rt::Box::new(val));
                        unsafe { Self::from_handle(T::_resource_new(ptr.cast())) }
                    }

                    /// Gets access to the underlying `T` which represents this resource.
                    pub fn get<T: GuestRuntimeBuilder>(&self) -> &T {
                        let ptr = unsafe { &*self.as_ptr::<T>() };
                        ptr.as_ref().unwrap()
                    }
                    ...
                    /// Gets mutable access to the underlying `T` which represents this
                    /// resource.
                    pub fn get_mut<T: GuestRuntimeBuilder>(&mut self) -> &mut T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.as_mut().unwrap()
                    }

                    /// Consumes this resource and returns the underlying `T`.
                    pub fn into_inner<T: GuestRuntimeBuilder>(self) -> T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.take().unwrap()
                    }
                    ...
                    // It's theoretically possible to implement the `GuestRuntimeBuilder` trait twice
                    // so guard against using it with two different types here.
                    #[doc(hidden)]
                    fn type_guard<T: 'static>() {
                        use core::any::TypeId;
                    ...
                    fn as_ptr<T: GuestRuntimeBuilder>(&self) -> *mut _RuntimeBuilderRep<T> {
                        RuntimeBuilder::type_guard::<T>();
                        unsafe { T::_resource_rep(self.handle()).cast() }
                    }
                }

                /// A borrowed version of [`RuntimeBuilder`] which represents a borrowed value
                /// with the lifetime `'a`.
                #[derive(Debug)]
                #[repr(transparent)]
                pub struct RuntimeBuilderBorrow<'a> {
                    rep: *mut u8,
                    _marker: core::marker::PhantomData<&'a RuntimeBuilder>,
                }

                impl<'a> RuntimeBuilderBorrow<'a> {
                    #[doc(hidden)]
                    pub unsafe fn lift(rep: usize) -> Self {
                        Self {
                            rep: rep as *mut u8,
                    ...
                    fn as_ptr<T: 'static>(&self) -> *mut _RuntimeBuilderRep<T> {
                        RuntimeBuilder::type_guard::<T>();
                        self.rep.cast()
                    }
                }

                unsafe impl _rt::WasmResource for RuntimeBuilder {
                    #[inline]
                    unsafe fn drop(_handle: u32) {
                        #[cfg(not(target_arch = "wasm32"))]
                        unreachable!();
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:spin-test-runner/runner"
                            )]
                            extern "C" {
                                #[link_name = "[resource-drop]runtime-builder"]
                                fn drop(_: u32);
                            }
                ...
                #[repr(transparent)]
                pub struct Runtime {
                    handle: _rt::Resource<Runtime>,
                }

                type _RuntimeRep<T> = Option<T>;
                ...
                impl Runtime {
                    ...
                    /// This function will create a new resource handle by moving `val` onto
                    /// the heap and then passing that heap pointer to the component model to
                    /// create a handle. The owned handle is then returned as `Runtime`.
                    pub fn new<T: GuestRuntime>(val: T) -> Self {
                        Self::type_guard::<T>();
                        let val: _RuntimeRep<T> = Some(val);
                        let ptr: *mut _RuntimeRep<T> = _rt::Box::into_raw(_rt::Box::new(val));
                        unsafe { Self::from_handle(T::_resource_new(ptr.cast())) }
                    }

                    /// Gets access to the underlying `T` which represents this resource.
                    pub fn get<T: GuestRuntime>(&self) -> &T {
                        let ptr = unsafe { &*self.as_ptr::<T>() };
                        ptr.as_ref().unwrap()
                    }
                    ...
                    /// Gets mutable access to the underlying `T` which represents this
                    /// resource.
                    pub fn get_mut<T: GuestRuntime>(&mut self) -> &mut T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.as_mut().unwrap()
                    }

                    /// Consumes this resource and returns the underlying `T`.
                    pub fn into_inner<T: GuestRuntime>(self) -> T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.take().unwrap()
                    }
                    ...
                    // It's theoretically possible to implement the `GuestRuntime` trait twice
                    // so guard against using it with two different types here.
                    #[doc(hidden)]
                    fn type_guard<T: 'static>() {
                        use core::any::TypeId;
                    ...
                    fn as_ptr<T: GuestRuntime>(&self) -> *mut _RuntimeRep<T> {
                        Runtime::type_guard::<T>();
                        unsafe { T::_resource_rep(self.handle()).cast() }
                    }
                }

                /// A borrowed version of [`Runtime`] which represents a borrowed value
                /// with the lifetime `'a`.
                #[derive(Debug)]
                #[repr(transparent)]
                pub struct RuntimeBorrow<'a> {
                    rep: *mut u8,
                    _marker: core::marker::PhantomData<&'a Runtime>,
                }

                impl<'a> RuntimeBorrow<'a> {
                    #[doc(hidden)]
                    pub unsafe fn lift(rep: usize) -> Self {
                        Self {
                            rep: rep as *mut u8,
                    ...
                    fn as_ptr<T: 'static>(&self) -> *mut _RuntimeRep<T> {
                        Runtime::type_guard::<T>();
                        self.rep.cast()
                    }
                }

                unsafe impl _rt::WasmResource for Runtime {
                    #[inline]
                    unsafe fn drop(_handle: u32) {
                        #[cfg(not(target_arch = "wasm32"))]
                        unreachable!();
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            ...
                            extern "C" {
                                #[link_name = "[resource-drop]runtime"]
                                fn drop(_: u32);
                            }
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_constructor_runtime_builder_cabi<T: GuestRuntimeBuilder>(
                ) -> i32 {
                    let result0 = RuntimeBuilder::new(T::new());
                    (result0).take_handle() as i32
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_runtime_builder_key_value_cabi<
                    T: GuestRuntimeBuilder,
                >(
                    arg0: i32,
                    arg1: i32,
                ) {
                    T::key_value(RuntimeBuilderBorrow::lift(arg0 as u32 as usize).get(), super::super::super::super::exports::component::spin_test_runner::host_impls::KeyValue::from_handle(arg1 as u32));
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_runtime_builder_build_cabi<T: GuestRuntimeBuilder>(
                    arg0: i32,
                ) -> i32 {
                    let result0 = T::build(RuntimeBuilderBorrow::lift(arg0 as u32 as usize).get());
                    (result0).take_handle() as i32
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_runtime_trigger_http_cabi<T: GuestRuntime>(
                    arg0: i32,
                    arg1: i32,
                ) -> i32 {
                    let result0 = T::trigger_http(
                        RuntimeBorrow::lift(arg0 as u32 as usize).get(),
                ...
                pub trait Guest {
                    type RuntimeBuilder: GuestRuntimeBuilder;
                    type Runtime: GuestRuntime;
                }
                pub trait GuestRuntimeBuilder: 'static {
                    #[doc(hidden)]
                    unsafe fn _resource_new(val: *mut u8) -> u32
                    where
                        Self: Sized,
                    {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            ...
                            extern "C" {
                                #[link_name = "[resource-new]runtime-builder"]
                                fn new(_: *mut u8) -> u32;
                            }
                            new(val)
                        }
                        ...
                        Self: Sized,
                    {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            ...
                            extern "C" {
                                #[link_name = "[resource-rep]runtime-builder"]
                                fn rep(_: u32) -> *mut u8;
                            }
                            unsafe { rep(handle) }
                        }
                    ...
                    fn new() -> Self;
                    fn key_value(&self, key_value: KeyValue);
                    fn build(&self) -> Runtime;
                }
                pub trait GuestRuntime: 'static {
                    #[doc(hidden)]
                    unsafe fn _resource_new(val: *mut u8) -> u32
                    where
                        Self: Sized,
                    {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            ...
                            extern "C" {
                                #[link_name = "[resource-new]runtime"]
                                fn new(_: *mut u8) -> u32;
                            }
                            new(val)
                        }
                        ...
                        Self: Sized,
                    {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            ...
                            extern "C" {
                                #[link_name = "[resource-rep]runtime"]
                                fn rep(_: u32) -> *mut u8;
                            }
                            unsafe { rep(handle) }
                        }
                ...
                macro_rules! __export_component_spin_test_runner_runner_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[export_name = "component:spin-test-runner/runner#[constructor]runtime-builder"]
    unsafe extern "C" fn export_constructor_runtime_builder() -> i32 {
      $($path_to_types)*::_export_constructor_runtime_builder_cabi::<<$ty as $($path_to_types)*::Guest>::RuntimeBuilder>()
    }
    #[export_name = "component:spin-test-runner/runner#[method]runtime-builder.key-value"]
    unsafe extern "C" fn export_method_runtime_builder_key_value(arg0: i32,arg1: i32,) {
      $($path_to_types)*::_export_method_runtime_builder_key_value_cabi::<<$ty as $($path_to_types)*::Guest>::RuntimeBuilder>(arg0, arg1)
    }
    #[export_name = "component:spin-test-runner/runner#[method]runtime-builder.build"]
    unsafe extern "C" fn export_method_runtime_builder_build(arg0: i32,) -> i32 {
      $($path_to_types)*::_export_method_runtime_builder_build_cabi::<<$ty as $($path_to_types)*::Guest>::RuntimeBuilder>(arg0)
    }
    #[export_name = "component:spin-test-runner/runner#[method]runtime.trigger-http"]
    unsafe extern "C" fn export_method_runtime_trigger_http(arg0: i32,arg1: i32,) -> i32 {
      $($path_to_types)*::_export_method_runtime_trigger_http_cabi::<<$ty as $($path_to_types)*::Guest>::Runtime>(arg0, arg1)
    }
  };);
}
                #[doc(hidden)]
                pub(crate) use __export_component_spin_test_runner_runner_cabi;
            }
        }
    }
}
...
macro_rules! __export_test_runner_impl {
  ($ty:ident) => (self::export!($ty with_types_in self););
  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
  $($path_to_types_root)*::exports::component::spin_test_runner::host_impls::__export_component_spin_test_runner_host_impls_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::spin_test_runner::host_impls);
  $($path_to_types_root)*::exports::component::spin_test_runner::runner::__export_component_spin_test_runner_runner_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::spin_test_runner::runner);
  )
}
#[doc(inline)]
pub(crate) use __export_test_runner_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:test-runner:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6966] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xb45\x01A\x02\x01A\x18\
...
-request\x02\x03\0\x04\x11incoming-response\x01B\x0e\x02\x03\x02\x01\x0a\x04\0\x0c\
http-request\x03\0\0\x02\x03\x02\x01\x0b\x04\0\x0dhttp-response\x03\0\x02\x04\0\x08\
instance\x03\x01\x01i\x04\x01j\x01\x05\x01s\x01@\0\0\x06\x04\0\x17[static]instan\
ce.create\x01\x07\x01h\x04\x01i\x01\x01i\x03\x01@\x02\x04self\x08\x03req\x09\0\x0a\
\x04\0\x1d[method]instance.trigger-http\x01\x0b\x03\x01\x1fcomponent:spin-test-r\
unner/spin\x05\x0c\x01B\x0c\x04\0\x09key-value\x03\x01\x01i\0\x01@\0\0\x01\x04\0\
\x16[constructor]key-value\x01\x02\x01h\0\x01p}\x01@\x03\x04self\x03\x03keys\x05\
value\x04\x01\0\x04\0\x15[method]key-value.set\x01\x05\x01o\x02s\x04\x01p\x06\x01\
@\x01\x04self\x03\0\x07\x04\0\x17[method]key-value.state\x01\x08\x04\x01%compone\
nt:spin-test-runner/host-impls\x05\x0d\x02\x03\0\x06\x09key-value\x01B\x17\x02\x03\
\x02\x01\x0a\x04\0\x0chttp-request\x03\0\0\x02\x03\x02\x01\x0b\x04\0\x0dhttp-res\
ponse\x03\0\x02\x02\x03\x02\x01\x0e\x04\0\x09key-value\x03\0\x04\x04\0\x0fruntim\
e-builder\x03\x01\x04\0\x07runtime\x03\x01\x01i\x06\x01@\0\0\x08\x04\0\x1c[const\
ructor]runtime-builder\x01\x09\x01h\x06\x01i\x05\x01@\x02\x04self\x0a\x09key-val\
ue\x0b\x01\0\x04\0![method]runtime-builder.key-value\x01\x0c\x01i\x07\x01@\x01\x04\
self\x0a\0\x0d\x04\0\x1d[method]runtime-builder.build\x01\x0e\x01h\x07\x01i\x01\x01\
i\x03\x01@\x02\x04self\x0f\x03req\x10\0\x11\x04\0\x1c[method]runtime.trigger-htt\
p\x01\x12\x04\x01!component:spin-test-runner/runner\x05\x0f\x04\x01&component:sp\
in-test-runner/test-runner\x04\0\x0b\x11\x01\0\x0btest-runner\x03\0\0\0G\x09prod\
